...
- Function **showSendEmailForm** takes the input data object and gives to the meeting send mail form.
- In action, function **showSendEmailFormView** will be called from MeetingView.php which displays the email form view tpl page.
- The display tpl page will be **showSendEmailForm** in views folder.
